/* AA : AA Main dashboard : weekly ats hires 7 days by approved date : prod */ 
SELECT
   ...
   count(distinct `opportunity_operational_hires`.`opportunity_id`) AS `opps_hire_weekly_ats7days`
FROM
